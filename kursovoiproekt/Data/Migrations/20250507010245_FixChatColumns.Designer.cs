...
namespace kursovoiproekt.Data.Migrations
{
    ...
    [Migration("20250507010245_FixChatColumns")]
    partial class FixChatColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("kursovoiproekt.Models.Chat", b =>
                {
                    ...
                    b.HasOne("kursovoiproekt.Models.JobAd", null)
                        .WithMany("Chats")
                        .HasForeignKey("JobAdId1");
